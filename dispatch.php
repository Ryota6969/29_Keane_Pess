...
<?php require 'nav.php'; ?>
<?php require 'db.php'; ?>
<?php if (isset($_POST["btnDispatch"]))
{
require_once 'db.php';
...
<tr>
<td colspan="2">
<strong><center>Incident Detail</center></strong>
</td>
...
<tr>
<td colspan="2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="btnDispatch" value="Dispatch"></td>
</tr>
</table>
</form>
</fieldset>
